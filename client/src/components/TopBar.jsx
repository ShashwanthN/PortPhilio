...
const TopBar = () => {
    ...
    return (
        <div className='topbar w-full flex items-center text-primary justify-between py-2 md:py-1 px-4 bg-ascent-1'>
            ...
            <div className='flex gap-4 items-center text-primary hover:text-shadow-lg text-md md:text-xl relative'>
                ...
                >
                    ...
                    <div className='flex text-grey hover:text-bg2 items-center gap-2  border-l-4 border-dashed border-grey rounded-r-full pr-1'>
...
// export default function Exampler() {
